...
test('lazy', function (t) {
  ...
  t.test('renders any type of mixed content', function (t) {
  ...
  t.test('renders async partial', function (t) {
    t.plan(2)
    var div = render(html`
      <div>
  ...
  t.test('forwards error to fallback', function (t) {
    t.plan(3)
    var state = 0
    var div = render(html`
      <div>
...
test('component', function (t) {
  ...
  t.test('component can render', function (t) {
    var id = makeId()
    var div = document.createElement('div')
    div.innerHTML = '<span>Hi <strong>world</strong>!</span>'
    document.body.appendChild(div)
  ...
  t.test('component can render fragment', function (t) {
    var update
    var Greeting = Component(function Greeting (text) {
      update = onupdate()
  ...
  t.test('component can update', function (t) {
    t.plan(6)
  ...
  t.test('component can memoize arguments', function (t) {
    t.plan(12)
  ...
  t.test('component can access children with ref', function (t) {
    t.plan(7)
  ...
  t.test('component is notified of being added to the DOM', function (t) {
    t.plan(4)
