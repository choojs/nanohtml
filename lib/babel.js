...
module.exports = (babel) => {
  ...
  const createNsCustomBuiltIn = (ns, tag, is) =>
    t.callExpression(
      t.memberExpression(t.identifier('document'), t.identifier('createElementNS')),
      [ns, t.stringLiteral(tag), t.objectExpression([t.objectProperty('is', t.stringLiteral(is))])]
    )
  ...
  */
  ...
  const createCustomBuiltIn = (tag, is) =>
    t.callExpression(
      t.memberExpression(t.identifier('document'), t.identifier('createElement')),
      [t.stringLiteral(tag), t.objectExpression([t.objectProperty('is', t.stringLiteral(is))])]
    )
